...
public class CategoryServiceRESTClient {
	...
	private static void testGetCategory(final String format) {
		...
		WebClient client = WebClient.create(CATEGORY_URL);
		Category category = client.path("/categoryservice/category/" + CATEGORY_ID).accept(format).type(format)
				.get(Category.class);
	...
	private static void testGetBooksForCategory(final String format) {
		...
		Category categoryBooks = clientBook.path("/categoryservice/category/" + CATEGORY_ID + "/books").type(format)
				.accept(format).get(Category.class);
	...
	private static void testDeleteCategory(final String format) {
		...
		WebClient client = WebClient.create(CATEGORY_URL);
		client.path("/categoryservice/category/" + CATEGORY_ID).type(format).accept(format);
